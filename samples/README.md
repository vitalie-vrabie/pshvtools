...
- `samples/hvcompact.samples.ps1` – VHD compaction examples (`Invoke-VHDCompact` / `hvcompact` / `hv-compact`)
- `samples/hvfixacl.samples.ps1` – VHD ACL repair examples (`Repair-VhdAcl` / `hvfixacl` / `hv-fixacl`)
